    ...
    <>
      ...
      <nav style={{
        ...
        <div className="nav-desktop">
          ...
          <a href="https://www.instagram.com/digitalwithchiragofficial" target="_blank" rel="noreferrer" style={{ color: 'var(--muted)', textDecoration: 'none', transition: 'color 0.2s', display: 'flex' }}
      ...
      <div className={`mobile-menu${menuOpen ? ' open' : ''}`}>
        ...
        <div className="mobile-socials">
          <a href="https://www.instagram.com/digitalwithchiragofficial" target="_blank" rel="noreferrer" style={{ color: 'var(--muted)', display: 'flex', transition: 'color 0.2s' }}
            onMouseEnter={e => e.currentTarget.style.color = '#E1306C'}
            onMouseLeave={e => e.currentTarget.style.color = 'var(--muted)'}>
            {igSvg}
          </a>
